...
SYSLIBS="$LIBM $LIBC"
ABIFLAGS=""
LIBS="-lpython3.11 -ldl  -lsqlite3 -lffi -lcrypto1.1 -lssl1.1 -llzma -lbz2 -lz $SYSLIBS"
LIBS_EMBED="-lpython${VERSION}${ABIFLAGS} -ldl  -lsqlite3 -lffi -lcrypto1.1 -lssl1.1 -llzma -lbz2 -lz $SYSLIBS"
